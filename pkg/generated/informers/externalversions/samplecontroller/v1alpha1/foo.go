...
import (
	...
	samplecontrollerv1alpha1 "k8s.io/application-aware-controller/pkg/apis/samplecontroller/v1alpha1"
	versioned "k8s.io/application-aware-controller/pkg/generated/clientset/versioned"
	internalinterfaces "k8s.io/application-aware-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/application-aware-controller/pkg/generated/listers/samplecontroller/v1alpha1"
)

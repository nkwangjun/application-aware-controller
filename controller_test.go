...
import (
	...
	samplecontroller "k8s.io/application-aware-controller/pkg/apis/samplecontroller/v1alpha1"
	"k8s.io/application-aware-controller/pkg/generated/clientset/versioned/fake"
	informers "k8s.io/application-aware-controller/pkg/generated/informers/externalversions"
)
